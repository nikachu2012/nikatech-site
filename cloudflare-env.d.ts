/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: eb000efa3aa11a700dfc30a33951b9db)
// Runtime types generated with workerd@1.20250428.0 2024-12-30 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		nikatech_receipt: KVNamespace;
		NEXTJS_ENV: string;
		NEXT_INC_CACHE_R2_BUCKET: R2Bucket;
		NIKATECH_ASSETS: R2Bucket;
