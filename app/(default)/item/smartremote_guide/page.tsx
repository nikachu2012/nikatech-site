    ...
    <HeaderFooter>
      <main className="flex flex-col flex-wrap gap-6 py-4">
        ...
        <Section title={"概要"} id="detail">
          ...
          <div>
            <Link className="link" href={"https://techbookfest.org/product/sHqRMvxL9p3ECYEksZK1Gw"} target="_blank">
              技術書典の頒布ページはこちら
            </Link><br />
            <Link className="link" href={"https://nikatech.booth.pm/items/7043844"} target="_blank">
              BOOTHの頒布ページはこちら
            </Link><br />
          </div>
        </Section>
        ...
        <Section title={"サポート"}>
          ...
          <Link className="link" href={"https://github.com/nikachu2012/smartremote_guide_source"} target="_blank">
            ソースコードはこちら
          </Link>
