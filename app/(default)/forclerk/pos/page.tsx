        ...
        <HeaderFooter>
            <div className="mt-8 mb-4">
                <div>
                    ...
                    <div className="flex gap-2 flex-wrap">
                        <span className="font-mono">{GetDateISO8601String(new Date("2026-04-11T00:30:12+09:00"))}</span>
            ...
            <main className="flex flex-col flex-wrap gap-6 py-4">
                ...
                <Section title={"取引登録"} id="posDetail">
                    ...
                    <p>
                        商品についているバーコードを読み取るか、画面上部の商品ボタンを押します。
                    </p>
                    <div className="flex justify-center">
                    ...
                    <div className="bg-yellow-200 border border-yellow-400 p-2 rounded">
                        書籍のような２段バーコードの場合は上段を読み取ってください。<br />
                    </div>
                    <p>
                    ...
                    <p>
                        ...
                        基本的にSQとついている方を優先的に選択してください。ただし、QRコード決済はAirQRを選択してください。
                    </p>

                    <div className="flex justify-center">
                        <Image src={paymentMethod} alt={"決済方法"} width={700} className="shadow" />
                    </div>
                    <p>
                        それ以外の決済方法の場合は決済ex→決済方法の順に選択してください。
                    </p>
                    <div className="flex justify-center">
                        <Image src={paymentEx} alt={"決済方法"} width={700} className="shadow" />
                    </div>
                    ...
                    <p>
                        預かり金がちょうどの場合、1000円、500円の場合はそのキーを押すことで１発で入力できます。
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        個数、預りのいずれの状態でもない時に<span className="text-blue-600">OK</span>を押すとチェックアウトへ進むことができます。
                    </p>
                    <div className="flex justify-center">
                    ...
                    <p>
                        ...
                        Airペイ（Air）のついたクレジット、QRコード決済の場合は自動で決済アプリへ遷移します。<br />
                        Square（SQ）の付いた決済方法の場合は自動で決済端末が起動します。決済ステータスが<span className="text-green-600">成功</span>になるまで待ってください。<br />
                        それ以外のキャッシュレス決済を指定された場合は、代表を呼んでください。
                    </p>

                    <p>
                        Squareの場合は決済端末（Squareターミナル）が起動するので、お客様に決済をお願いしてください。
                    </p>
                    <div className="flex justify-center">
                        <Image src={square_kessai} alt={"Squareターミナルの画面"} width={400} className="shadow" />
                    </div>
                    ...
                    <div className="bg-red-200 border border-red-400 p-2 rounded">
                        Airペイでの決済時にはお客様控えが印刷されます。必ず切り取ってからレシートを印刷してください。
                    </div>
                    <div className="bg-yellow-200 border border-yellow-400 p-2 rounded">
                        領収書ボタンで領収書を印刷できます。レシートと領収書はどちらか一方しか発行できません（片方を発行するとボタンが押せなくなります）。
                    </div>
                    <div className="bg-yellow-200 border border-yellow-400 p-2 rounded">
                        Airペイ決済の場合、POSに戻った後のレシート印刷に時間がかかり、その間固まったように見えることがあります。<br />
